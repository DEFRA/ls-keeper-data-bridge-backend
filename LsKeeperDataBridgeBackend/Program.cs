using LsKeeperDataBridgeBackend.Example.Endpoints;
using LsKeeperDataBridgeBackend.Example.Services;
using LsKeeperDataBridgeBackend.Utils;
using LsKeeperDataBridgeBackend.Utils.Http;
using LsKeeperDataBridgeBackend.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using LsKeeperDataBridgeBackend.Config;
using LsKeeperDataBridgeBackend.Utils.Logging;
using Serilog;
